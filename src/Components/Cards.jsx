  ...
  const arr = [
    {
      ...
      title: "Why BNYS at SONA?",
      content:
        "Sona is one of the premiere institutes excelling in education since many decades. Sona Medical College of Naturopathy and Yoga is an emerging Top college in Salem. The teaching faculties in our college are experienced in both clinical and academic aspects.",
      read: "Read BNYS",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      title: "Why Sona?",
      content:
        "Having achieved excellence in technology, technical education and research, Sona brings to you Sona medical college – a venture to promote Indian heritage medicines and health practices and create an environment for the growth of Ayush.",
